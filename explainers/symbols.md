...
* **Use of the `<ruby>` element for presentation&mdash;with a [`lang=zbl`](https://www.loc.gov/standards/iso639-2/php/code_list.php) attribute to indicate this is a symbol.**
